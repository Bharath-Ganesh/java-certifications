...
class TextFilter {
    ...
    public static boolean newMethod(String s) {
        return s.equals("remove A");
    }
...
public class LambdaExpressionAndMethod {
    ...
    public static void main(String[] args) {
         ...
         */
        Comparator<String> comparisonComparator=(word1,word2)->word1.compareToIgnoreCase(word2);
        list.sort(comparisonComparator);

...
public class BigDecimalAndLocalisation {
    ...
    public static void main(String[] args) {
        ...
        // Hence it would lead to unnecessary decimal points
        ...
        // It's designed to work specifically with decimal numbers
        ...
        System.out.println(resultPrice); // 1.72975
        ...
        System.out.println(scaledPrice); // 1.73
        ...
        NumberFormat canCurrentFormat = NumberFormat.getCurrencyInstance(canada);
        NumberFormat canPercentFormat = NumberFormat.getPercentInstance(canada);



        // Sets the maximum number of digits allowed in the fraction portion of a number.
        ukPercentFormat.setMaximumFractionDigits(2);
        canPercentFormat.setMaximumFractionDigits(2);

        System.out.println(ukCurrentFormat.format(price)); // £1.73
        System.out.println(ukPercentFormat.format(rate)); //  6.5%

        System.out.println(canCurrentFormat.format(price)); // $1.73
        System.out.println(canPercentFormat.format(rate)); //  6.5%
